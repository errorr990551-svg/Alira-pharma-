...
const faqData = [
  {
    question: "Do you export surgical instruments directly to Dawadmi?",
    answer: "Yes, Alira Pharmaceuticals has a dedicated export wing that handles direct shipments to public and private hospitals, distributors, and clinics throughout the Dawadmi region."
  },
  {
  ...
  {
    question: "What is the typical lead time for an export order to Dawadmi?",
    answer: "Lead times vary based on volume, but our logistics network is optimized for fast transit to the Riyadh Province and subsequent delivery to Dawadmi."
  },
  {
    question: "Can I request a bulk quote for medical disposables in Dawadmi?",
  ...
  {
    question: "Do you provide samples to Dawadmi hospitals?",
    answer: "Yes, we understand the need for quality assurance. We can arrange for product samples to be sent to your facility in Dawadmi for evaluation by your clinical or procurement team."
  }
];
...
const DawadmiPage = () => {
    ...
    useEffect(() => {
        // SEO Configuration
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Dawadmi";

        // Update Meta Description
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of high-quality surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for hospitals and clinics in Dawadmi and the Riyadh Province.";
        ...
        const keywordsContent = "Surgical instruments Dawadmi, medical supplies Dawadmi KSA, wholesale medical disposables Riyadh Province, Dawadmi healthcare suppliers, hospital equipment exporter Saudi Arabia, Dawadmi General Hospital supplies.";
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
                Global Manufacturer & Exporter of Surgical & Medical Supplies to Dawadmi
              </h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Supporting Dawadmi’s healthcare infrastructure with precision-crafted surgical instruments, certified PPE, and premium medical disposables tailored for the Riyadh Province’s growing needs.
              </p>
              ...
              <div className="w-full lg:w-5/12 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 bg-gray-100 group">
                  <img 
                    ...
                    alt="Alira Medical Export Dawadmi" 
                    width={400}
                    height={500}
                ...
                <div className="space-y-10 text-gray-700 leading-relaxed text-justify">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">
                      Pharmaceutical Distributors for Dawadmi
                    </h3>
                    <p>
                      Alira Pharmaceuticals specializes in the strategic sourcing and distribution of generic medications and essential medical supplies tailored for the <span className="font-semibold text-teal-700">Dawadmi healthcare market</span>. We serve the region’s public and private medical centers, ensuring they receive compliant, high-efficacy products that meet international safety and SFDA standards.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">
                      Surgical Instruments Suppliers in Dawadmi
                    </h3>
                    <p>
                      We provide <span className="font-semibold text-teal-700">Dawadmi’s surgical teams</span> with the precision they demand. Our Surgical Instruments are forged from medical-grade stainless steel, ensuring durability for complex procedures in institutions like Dawadmi General Hospital. From Retractors to specialized surgical tools, we are your trusted partner for operating room excellence.
                    </p>
                  </div>
              ...
              <div className="w-full lg:w-1/2 relative">
                ...
                <div className="relative rounded-[3rem] overflow-hidden shadow-2xl aspect-4/3 group">
                  <img 
                    ...
                    alt="Global Medical Logistics for Dawadmi" 
                    width={600}
                    height={450}
                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
        ...
        {/* --- WHY CHOOSE ALIRA DAWADMI --- */}
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">
                Why Choose Alira for Dawadmi Exports?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                  We are equipped to handle large-scale bulk orders for Dawadmi’s medical facilities, supporting both community and specialized care.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                  20+ years of experience in international shipping with optimized routes to the Riyadh Province, ensuring efficient delivery to Dawadmi and its surrounding areas.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
                  Leading Medical Supply Manufacturers for Dawadmi
                </h3>
              </div>
              <div className="w-full md:w-7/12">
                <p className="text-gray-600 text-lg leading-relaxed text-justify">
                  Alira Pharmaceuticals offers a unique variety of surgical instruments, PPE, and medical disposables tailored for the <span className="font-semibold text-teal-700">Dawadmi market</span>. We are a prominent manufacturer and supplier in the healthcare industry, with 20+ years of experience navigating international shipping and Saudi customs requirements. Following the latest regulatory standards, our supplies add reliability and operational efficiency to your medical facility in Dawadmi.
                </p>
              </div>
            </div>
