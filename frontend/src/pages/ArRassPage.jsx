...
const faqData = [
  {
    ...
    answer: "Yes, Alira Pharmaceuticals has a dedicated export wing that handles direct shipments to public and private hospitals, distributors, and clinics throughout the Ar Rass region."
  },
  {
              ...
              <div className="w-full lg:w-5/12 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 bg-gray-100 group">
                  <img 
                    ...
                    alt="Alira-Medical-Export-Ar-Rass" 
                    width={400}
                    height={500}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
              <div className="w-full lg:w-1/2 relative">
                ...
                <div className="relative rounded-[3rem] overflow-hidden shadow-2xl aspect-4/3 group"><img 
                    ...
                    alt="Global-Medical-Logistics-Ar-Rass" 
                    width={600}
                    height={450}
                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  /></div>
