...
const faqData = [
  {
    question: "Do you export surgical instruments directly to Al Baha?",
    answer: "Yes, Alira Pharmaceutical has a dedicated export wing that handles direct shipments to public and private hospitals, distributors, and clinics throughout the Al Baha region."
  },
  {
  ...
  {
    question: "What is the typical lead time for an export order to Al Baha?",
    answer: "Lead times vary based on volume, but our logistics network is optimized for fast transit to the Al Bahah Province and subsequent delivery to Al Baha."
  },
  {
    question: "Can I request a bulk quote for medical disposables in Al Baha?",
  ...
  {
    question: "Do you provide samples to Al Baha hospitals?",
    answer: "Yes, we understand the need for quality assurance. We can arrange for product samples to be sent to your facility in Al Baha for evaluation by your clinical or procurement team."
  }
];
...
const AlBahaPage = () => {
    ...
    useEffect(() => {
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Al Baha";
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of high-quality surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for hospitals and clinics in Al Baha and the Al Bahah Province.";
        ...
        const keywordsContent = "Surgical instruments Al Baha, medical supplies Al Bahah Province, wholesale medical disposables Al Baha, Al Baha healthcare suppliers, hospital equipment exporter Saudi Arabia, Al Baha medical institutions, King Fahd Hospital Al Baha supplies.";
        if (metaKeywords) metaKeywords.setAttribute('content', keywordsContent);
        else {
            metaKeywords = document.createElement('meta');
            metaKeywords.name = "keywords";
            metaKeywords.content = keywordsContent;
            document.head.appendChild(keywordsContent);
        }
    }, [location]);
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
        <div className="relative bg-teal-900 pt-32 pb-48 lg:pt-40 lg:pb-64 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')` }}>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">Global Manufacturer & Exporter of Surgical & Medical Supplies to Al Baha</h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">Supporting the healthcare needs of Al Baha with precision-crafted surgical instruments, certified PPE, and premium medical disposables tailored for the Al Bahah Province’s medical sector.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={catalogPDF} download="Alira-Pharmaceuticals-Catalog.pdf" className="px-8 py-3 rounded-md border-2 border-teal-100 text-teal-50 font-semibold hover:bg-white hover:text-teal-900 transition-colors inline-block text-center">Download Al Baha Product Catalog</a>
            ...
            <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
              <div className="w-full lg:w-5/12 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 bg-gray-100 group">
                  <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=800" alt="Alira-Medical-Export-Al-Baha" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
              ...
              <div className="w-full lg:w-7/12">
                ...
                <div className="space-y-10 text-gray-700 leading-relaxed text-justify">
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Pharmaceutical Distributors for Al Baha</h3>
                    <p>Alira Pharmaceutical specializes in the strategic sourcing and distribution of generic medications and essential medical supplies tailored for the <span className="font-semibold text-teal-700">Al Baha healthcare market</span>. We serve the region’s network of hospitals and clinics, ensuring they receive compliant, high-efficacy products that meet international safety and SFDA standards.</p>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">Surgical Instruments Suppliers in Al Baha</h3>
                    <p>We provide <span className="font-semibold text-teal-700">Al Baha’s surgical teams</span> with the precision they demand for specialized care. Our Surgical Instruments are forged from medical-grade stainless steel, ensuring durability for complex procedures in institutions like <span className="font-semibold text-teal-700">King Fahd Hospital</span>. From Retractors to specialized tools, we are your trusted partner for operating room excellence.</p>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">Wholesale Medical Disposables in Al Baha</h3>
                    <p>Hygiene and infection control are the foundation of Al Baha’s modern healthcare facilities. As a leading <span className="font-semibold text-teal-700">Wholesale Medical Disposables Supplier</span>, we offer clinics a robust inventory of Gloves, Surgical Gowns, and Wound Care products designed for single-use safety and uncompromised hygiene.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20"><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">Why Choose Alira for Al Baha Exports?</h2><div className="h-1.5 w-24 bg-teal-500 mx-auto rounded-full"></div></div>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">20+ years of experience in international shipping with optimized routes to the Southern region of Saudi Arabia, ensuring efficient delivery to Al Baha and surrounding areas.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12"><h2 className="text-xl md:text-2xl font-bold text-teal-600 uppercase tracking-widest mb-2">MEDICAL SUPPLIES EXPORT</h2><h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">Leading Medical Supply Manufacturers for Al Baha</h3></div>
              <div className="w-full md:w-7/12"><p className="text-gray-600 text-lg leading-relaxed text-justify">Alira Pharmaceutical offers a unique variety of surgical instruments, PPE, and medical disposables tailored for the <span className="font-semibold text-teal-700">Al Baha market</span>. We are a prominent manufacturer and supplier in the healthcare industry, leveraging major shipping routes to the Southern region of Saudi Arabia for faster delivery. Following the latest regulatory standards, our supplies add reliability and operational efficiency to your medical facility in Al Baha.</p></div>
            </div>
