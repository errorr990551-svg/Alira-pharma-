...
const faqData = [
  {
    question: "Do you export surgical instruments directly to Khafji?",
    answer: "Yes, Alira Pharmaceuticals has a dedicated export wing that handles direct shipments to public and private hospitals, distributors, and clinics throughout the Khafji region."
  },
  {
    question: "Are your medical products compliant with Saudi SFDA standards?",
    answer: "Our products are manufactured according to international quality benchmarks (like ISO) and are designed to meet the safety and regulatory standards required for the Saudi market and the Eastern Province healthcare network."
  },
  {
    question: "What is the typical lead time for an export order to Khafji?",
    answer: "Lead times vary based on volume, but our logistics network is optimized for fast transit to Dammam port and subsequent delivery to Khafji."
  },
  {
    question: "Can I request a bulk quote for medical disposables in Khafji?",
  ...
  {
    question: "Do you provide samples to Khafji hospitals?",
    answer: "Yes, we understand the need for quality assurance. We can arrange for product samples to be sent to your facility in Khafji for evaluation by your clinical or procurement team."
  }
];
...
const KhafjiPage = () => {
    ...
    useEffect(() => {
        // SEO Configuration
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Khafji";

        // Update Meta Description
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of high-quality surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for hospitals and clinics in Khafji and the Eastern Province.";
        ...
        const keywordsContent = "Surgical instruments Khafji, medical supplies Khafji KSA, wholesale medical disposables Eastern Province, Khafji healthcare suppliers, hospital equipment exporter Saudi Arabia, Khafji General Hospital supplies.";
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
                Global Manufacturer & Exporter of Surgical & Medical Supplies to Khafji
              </h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Supporting the healthcare needs of Khafji with precision-crafted surgical instruments, certified PPE, and premium medical disposables tailored for the Eastern Province’s growing medical sector.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={catalogPDF} download="Alira-Pharmaceuticals-Catalog.pdf" className="px-8 py-3 rounded-md border-2 border-teal-100 text-teal-50 font-semibold hover:bg-white hover:text-teal-900 transition-colors inline-block text-center">Download Khafji Product Catalog</a>
              ...
              <div className="w-full lg:w-5/12 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 bg-gray-100 group">
                  <img 
                    ...
                    alt="Alira Medical Export Khafji" 
                    width={400}
                    height={500}
                ...
                <div className="space-y-10 text-gray-700 leading-relaxed text-justify">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">
                      Surgical Instruments Suppliers in Khafji
                    </h3>
                    <p>
                      We provide <span className="font-semibold text-teal-700">Khafji’s surgical teams</span> with the precision they demand for specialized care. Our Surgical Instruments are forged from medical-grade stainless steel, ensuring durability for complex procedures in institutions like Khafji General Hospital. From Retractors to specialized tools, we are your trusted partner for operating room excellence.
                    </p>
                  </div>
              ...
              <div className="w-full lg:w-1/2 relative">
                ...
                <div className="relative rounded-[3rem] overflow-hidden shadow-2xl aspect-4/3 group">
                  <img 
                    ...
                    alt="Global Medical Logistics for Khafji" 
                    width={600}
                    height={450}
                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
        ...
        {/* --- WHY CHOOSE ALIRA KHAFJI --- */}
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">
                Why Choose Alira for Khafji Exports?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                  We are equipped to handle large-scale bulk orders for the Eastern Province’s healthcare infrastructure, supporting both public and private medical facilities.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                  20+ years of experience in international shipping with optimized routes to the Eastern Province, ensuring efficient delivery to Khafji and the surrounding border regions.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
                  Leading Medical Supply Manufacturers for Khafji
                </h3>
              </div>
              <div className="w-full md:w-7/12">
                <p className="text-gray-600 text-lg leading-relaxed text-justify">
                  Alira Pharmaceuticals offers a unique variety of surgical instruments, PPE, and medical disposables tailored for the <span className="font-semibold text-teal-700">Khafji market</span>. We are a prominent manufacturer and supplier in the healthcare industry, with 20+ years of experience navigating international shipping and Saudi customs requirements. Following the latest regulatory standards, our supplies add reliability and operational efficiency to your medical facility in Khafji.
                </p>
              </div>
            </div>
