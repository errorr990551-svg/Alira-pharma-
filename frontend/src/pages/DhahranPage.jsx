...
const faqData = [
  {
    question: "Do you export surgical instruments directly to Dhahran?",
    answer: "Yes, Alira Pharmaceutical has a dedicated export wing that handles direct shipments to hospitals, research centers, and private clinics throughout Dhahran and the Greater Dammam area."
  },
  {
  ...
  {
    question: "What is the typical lead time for an export order to Dhahran?",
    answer: "By leveraging the Eastern Province's primary logistics hubs, we optimize for fast transit. Lead times vary by order size, but our team ensures a streamlined path to Dhahran's medical facilities."
  },
  {
    question: "Can I request a bulk quote for medical disposables in Dhahran?",
    answer: "Absolutely. We specialize in wholesale supply for large institutions. You can Request a Quote via our website, and our team will provide competitive pricing tailored for the Dhahran sector."
  },
  {
    question: "Do you provide samples before a bulk purchase in Dhahran?",
    answer: "We understand the need for quality assurance in specialized medical centers. We can arrange for product samples to be sent to your facility in Dhahran for clinical evaluation."
  }
];
...
const DhahranPage = () => {
    ...
    useEffect(() => {
        // SEO Configuration
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Dhahran";

        // Update Meta Description
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of high-quality surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for private hospitals and specialized clinics in Dhahran, Saudi Arabia.";
        ...
        const keywordsContent = "Surgical instruments Dhahran, medical supplies Dhahran, wholesale medical disposables Dhahran, pharmaceutical distributors Eastern Province, hospital equipment exporter, medical supplies Khobar.";
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
        ...
        >
          ...
          <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Global manufacturer exporting surgical and medical supplies to Dhahran healthcare sectors." className="sr-only" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
                Global Manufacturer & Exporter of Surgical & Medical Supplies to Dhahran
              </h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Delivering precision-crafted surgical instruments, certified PPE, and premium medical disposables to the specialized medical centers and research hospitals of Dhahran.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={catalogPDF} download="Alira-Pharmaceuticals-Catalog.pdf" className="px-8 py-3 rounded-md border-2 border-teal-100 text-teal-50 font-semibold hover:bg-white hover:text-teal-900 transition-colors inline-block text-center">Download Dhahran Product Catalog</a>
              ...
              <div className="w-full lg:w-5/12 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 bg-gray-100 group">
                  <img 
                    ...
                    alt="Alira Medical Export Dhahran" 
                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
                  {/* Hidden img for SEO tools */}
                  <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=800" alt="High-quality medical-grade stainless steel surgical instruments for specialized medical centers in Dhahran." className="sr-only" />
                ...
                <div className="space-y-10 text-gray-700 leading-relaxed text-justify">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">
                        Pharmaceutical Distributors for Dhahran
                    </h3>
                    <p>
                       Alira Pharmaceutical specializes in the strategic sourcing and distribution of generic medications and essential medical supplies tailored for the <span className="font-semibold text-teal-700">Dhahran healthcare market</span>. We ensure our partners and research hospitals in the Eastern Province receive compliant, high-efficacy products that meet international safety and regulatory standards. Our professionals are dedicated to supporting the medical excellence of Dhahran.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">
                        Surgical Instruments Suppliers in Dhahran
                    </h3>
                    <p>
                       We provide <span className="font-semibold text-teal-700">Dhahran’s surgeons</span> and specialized surgical groups with the precision they demand. Our Surgical Instruments are forged from medical-grade stainless steel, ensuring durability for complex procedures. From Retractors to Neuro Instruments, we are your trusted partner for operating room excellence in the Eastern Hub.
                    </p>
                  </div>
              ...
              <div className="w-full lg:w-1/2 relative">
                ...
                <div className="relative rounded-[3rem] overflow-hidden shadow-2xl aspect-4/3 group">
                  <img 
                    ...
                    alt="Global-Medical-Logistics-Dhahran" 
                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
                  {/* Hidden img for SEO tools */}
                  <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=800" alt="Efficient supply chain and export network delivering medical supplies to Dhahran's elite medical sector." className="sr-only" />
                </div>
              </div>
        ...
        {/* --- WHY CHOOSE ALIRA DHAHRAN --- */}
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">
                Why Choose Alira for Dhahran Exports?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                   20+ years of experience navigating international shipping and Saudi customs for Dhahran's advanced medical and academic institutions.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Reliable Supply</h3>
                <p className="text-gray-600 leading-relaxed">
                   We specialize in consistent, high-volume wholesale supply for research hospitals and specialized medical centers in Dhahran.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
                   Leading Medical Supply Manufacturers for Dhahran
                </h3>
              </div>
              <div className="w-full md:w-7/12">
                <p className="text-gray-600 text-lg leading-relaxed text-justify">
                  Alira Pharmaceutical offers a unique variety of surgical instruments, PPE, and medical disposables tailored for the <span className="font-semibold text-teal-700">Dhahran market</span>. We are a prominent manufacturer and supplier in the healthcare industry, with 20+ years of experience navigating international shipping. Following the latest regulatory standards, our supplies add reliability and operational efficiency to your medical facility in Dhahran.
                </p>
              </div>
            </div>
