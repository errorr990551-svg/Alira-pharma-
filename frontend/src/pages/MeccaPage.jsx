...
const faqData = [
  {
    question: "Do you export surgical instruments directly to Mecca?",
    answer: "Yes, Alira Pharmaceutical has a dedicated export wing that handles direct shipments to hospitals, emergency centers, and private distributors throughout the Makkah region."
  },
  {
    question: "Can you handle bulk orders for seasonal healthcare demands in Makkah?",
    answer: "Absolutely. We are equipped to handle high-volume wholesale orders, specifically for PPE and disposables, to ensure your facility is prepared for peak visitor periods like Hajj and Umrah."
  },
  {
    question: "Are your medical products compliant with Saudi SFDA standards?",
    answer: "Our products are manufactured according to international quality benchmarks (like ISO and CE) and are designed to meet the safety and regulatory standards required for the Saudi Arabian healthcare market."
  },
  {
    question: "What is the typical lead time for an export order to Mecca?",
    answer: "We prioritize efficiency for the Makkah region. Lead times vary by order size, but our team works closely with Saudi customs and logistics partners to ensure the fastest possible transit."
  },
  {
    question: "How can I request a wholesale quote for my facility in Mecca?",
    answer: "You can Request a Quote directly through our website. Our export specialists will provide a competitive, tailored proposal for your specific requirements in the Holy City."
  }
];
...
const MeccaPage = () => {
    ...
    useEffect(() => {
        // SEO Configuration
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Mecca (Makkah)";

        // Update Meta Description
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of high-quality surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for hospitals, clinics, and emergency care centers in Mecca, Saudi Arabia.";
        ...
        const keywordsContent = "Surgical instruments Mecca, medical supplies Makkah, wholesale medical disposables Mecca, pharmaceutical distributors Makkah, Hajj medical supplies, hospital equipment exporter Saudi Arabia.";
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
        ...
        >
          ...
          <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Global manufacturer exporting surgical and medical supplies to Makkah healthcare institutions and clinics." className="sr-only" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
                Global Manufacturer & Exporter of Surgical & Medical Supplies to Mecca
              </h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Providing high-precision surgical tools, certified PPE, and bulk medical disposables to support the healthcare infrastructure of the Holy City of Makkah.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={catalogPDF} download="Alira-Pharmaceuticals-Catalog.pdf" className="px-8 py-3 rounded-md border-2 border-teal-100 text-teal-50 font-semibold hover:bg-white hover:text-teal-900 transition-colors inline-block text-center">Download Makkah Product Catalog</a>
              ...
              <div className="w-full lg:w-5/12 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 bg-gray-100 group">
                  <img 
                    ...
                    alt="Precision-Surgical-Instruments-Mecca" 
                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
                  {/* Hidden img for SEO */}
                  <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=800" alt="High-quality medical-grade stainless steel surgical instruments for specialized clinics in Makkah." className="sr-only" />
                ...
                <div className="space-y-10 text-gray-700 leading-relaxed text-justify">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">
                      Pharmaceutical Distributors for Mecca (Makkah)
                    </h3>
                    <p>
                      Alira Pharmaceutical specializes in the strategic sourcing and distribution of generic medications and essential medical supplies tailored for the <span className="font-semibold text-teal-700">unique healthcare needs of Mecca</span>. We ensure our Saudi partners receive compliant, high-efficacy products that meet international safety standards, especially during peak seasonal demands. Our professionals ensure that every facility is meticulously stocked with pharmaceutical solutions.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">
                      Surgical Instruments Suppliers in Mecca
                    </h3>
                    <p>
                      We provide <span className="font-semibold text-teal-700">Mecca’s surgical teams</span> and medical professionals with the precision they demand. Our Surgical Instruments are forged from premium medical-grade stainless steel, ensuring durability and performance for both routine and emergency procedures across the Makkah region. From Retractors to Bone instruments, we are your trusted partner for operating room excellence.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">
                      Wholesale Medical Disposables in Mecca
                    </h3>
                    <p>
                      With the massive influx of visitors to the Holy City, infection control is a top priority. As a leading <span className="font-semibold text-teal-700">Wholesale Medical Disposables Supplier</span>, we offer Makkah’s hospitals and clinics a robust inventory of Gloves, Surgical Gowns, and Wound Care products designed for maximum safety and hygiene. Each item is designed for single-use safety to support <span className="font-semibold text-teal-700">Mecca's healthcare delivery</span>.
                    </p>
                  </div>
        ...
        <div className="bg-gray-50 py-20 lg:py-28 relative">
          <div className="max-w-360 mx-auto px-4 sm:px-12 lg:px-16">
            ...
            <div className="text-center mb-16">
              ...
              <div className="h-1 w-24 bg-teal-50 mx-auto rounded-full"></div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
              ...
              <div className="w-full lg:w-1/2 relative">
                ...
                <div className="relative rounded-[3rem] overflow-hidden shadow-2xl aspect-4/3 group">
                  <img 
                    ...
                    alt="Global-Medical-Logistics-Mecca" 
                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
                  {/* Hidden img for SEO */}
                  <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=800" alt="Scalable supply chain delivering bulk medical disposables to support Mecca’s seasonal healthcare demands." className="sr-only" />
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/2">
                <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                  Precision Manufacturing, Worldwide Supply to Mecca
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8 text-justify">
                  Alira Pharmaceutical is a leading manufacturer and global exporter specialized in <span className="font-semibold text-teal-700">Mecca's seasonal healthcare demands</span>. With advanced production facilities and strict quality control systems, we deliver precision-crafted products trusted by healthcare professionals across international markets, specifically catering to the <span className="font-semibold text-teal-700">Holy City medical sector</span>. Our commitment to quality, compliance, and timely delivery ensures dependable supply during Hajj and Umrah peak seasons.
                </p>
              </div>
        ...
        {/* --- WHY CHOOSE ALIRA MECCA --- */}
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">
                Why Choose Alira for Mecca Exports?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">High-Volume Expertise</h3>
                <p className="text-gray-600 leading-relaxed">
                  We specialize in large-scale wholesale orders designed to meet the intensive demands of Makkah’s healthcare network.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Rapid Fulfillment</h3>
                <p className="text-gray-600 leading-relaxed">
                  Our logistics chain is optimized for the Saudi market, ensuring timely delivery even during high-traffic seasons like Hajj and Umrah.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                  All products carry international certifications (ISO/CE), ensuring they meet the rigorous regulatory standards of the Saudi Ministry of Health.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
                  Leading Medical Supply Manufacturers for Mecca
                </h3>
              </div>
              <div className="w-full md:w-7/12">
                <p className="text-gray-600 text-lg leading-relaxed text-justify">
                  Alira Pharmaceutical offers a unique variety of surgical instruments, PPE, and medical disposables tailored for the <span className="font-semibold text-teal-700">Mecca market</span>. We are a prominent manufacturer and supplier specializing in the high-demand healthcare needs of the Holy City. Following the latest regulatory standards, our supplies add reliability and operational efficiency to your hospital or clinic in Makkah.
                </p>
              </div>
            </div>
