...
const faqData = [
  ...
  {
    question: "What is the typical lead time for an export order to Ras Tanura?",
    answer: "Lead times vary based on volume, but our logistics network is optimized for fast transit to the Eastern Province. Contact our team for a specific timeline."
  },
  {
    question: "Can I request a bulk quote for medical disposables in Ras Tanura?",
    answer: "Absolutely. We specialize in wholesale supply for healthcare networks and large-scale industrial operations. You can Request a Quote via our website for competitive pricing."
  },
  {
    question: "Do you provide samples to Ras Tanura medical facilities?",
    answer: "Yes, we understand the need for quality assurance. We can arrange for product samples to be sent to your facility in Ras Tanura for evaluation by your clinical or procurement team."
  }
];
...
const RasTanuraPage = () => {
    ...
    useEffect(() => {
        // SEO Configuration
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Ras Tanura";

        // Update Meta Description
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of high-quality surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for industrial clinics and healthcare facilities in Ras Tanura, Saudi Arabia.";
        ...
        const keywordsContent = "Surgical instruments Ras Tanura, medical supplies Eastern Province, wholesale medical disposables Ras Tanura, industrial healthcare suppliers Saudi Arabia, hospital equipment exporter, Ras Tanura General Hospital supplies.";
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
                Global Manufacturer & Exporter of Surgical & Medical Supplies to Ras Tanura
              </h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Delivering precision-crafted surgical instruments, certified PPE, and premium medical disposables to support the critical healthcare and industrial infrastructure of Ras Tanura.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={catalogPDF} download="Alira-Pharmaceuticals-Catalog.pdf" className="px-8 py-3 rounded-md border-2 border-teal-100 text-teal-50 font-semibold hover:bg-white hover:text-teal-900 transition-colors inline-block text-center">Download Ras Tanura Product Catalog</a>
                ...
                <div className="space-y-10 text-gray-700 leading-relaxed text-justify">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">
                      Surgical Instruments Suppliers in Ras Tanura
                    </h3>
                    <p>
                      We provide <span className="font-semibold text-teal-700">Ras Tanura’s medical teams</span> with the precision they demand. Our Surgical Instruments are forged from medical-grade stainless steel, ensuring durability for procedures in general hospitals and specialized industrial clinics. From Retractors to specialized surgical tools, we are your trusted partner for clinical excellence.
                    </p>
                  </div>
        ...
        {/* --- WHY CHOOSE ALIRA RAS TANURA --- */}
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">
                Why Choose Alira for Ras Tanura Exports?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                <div className="w-16 h-16 bg-teal-50 rounded-2xl flex items-center justify-center text-teal-600 mb-8 group-hover:bg-teal-600 group-hover:text-white transition-colors duration-500">
                  <Factory className="w-8 h-8" strokeWidth={1.5} title="Industrial Sector Expertise" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Industrial Sector Expertise</h3>
                <p className="text-gray-600 leading-relaxed">
                  We specialize in high-volume wholesale orders designed to meet the rigorous safety and performance standards of Ras Tanura’s industrial and corporate healthcare networks.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                  All products are manufactured under strict ISO/CE quality control using medical-grade materials to meet the standards of the Saudi Ministry of Health.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                  20+ years of experience utilizing Eastern Province ports (like Dammam) to ensure rapid ground transport and efficient delivery to Ras Tanura.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
                  Leading Medical Supply Manufacturers for Ras Tanura
                </h3>
              </div>
