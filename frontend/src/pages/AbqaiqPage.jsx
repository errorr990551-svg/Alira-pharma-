...
const faqData = [
  {
    ...
    answer: "Yes, Alira Pharmaceutical has a dedicated export wing that handles direct shipments to public and private clinics, distributors, and hospitals across the Abqaiq region."
  },
  {
