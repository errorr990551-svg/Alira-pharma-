...
const faqData = [
  {
    question: "Do you export surgical instruments directly to Abqaiq?",
    answer: "Yes, Alira Pharmaceuticals has a dedicated export wing that handles direct shipments to public and private clinics, distributors, and hospitals across the Abqaiq region."
  },
  {
  ...
  {
    question: "What is the typical lead time for an export order to Abqaiq?",
    answer: "Lead times vary based on volume, but our logistics network is optimized for fast transit to Dammam port and subsequent delivery to Abqaiq."
  },
  {
    question: "Can I request a bulk quote for medical disposables in Abqaiq?",
  ...
  {
    question: "Do you provide samples to Abqaiq hospitals?",
    answer: "Yes, we understand the need for quality assurance. We can arrange for product samples to be sent to your facility in Abqaiq for evaluation by your clinical or procurement team."
  }
];
...
const AbqaiqPage = () => {
    ...
    useEffect(() => {
        // SEO Configuration
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Abqaiq";

        // Update Meta Description
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for clinics and healthcare facilities in Abqaiq and the Eastern Province.";
        ...
        const keywordsContent = "Surgical instruments Abqaiq, medical supplies Abqaiq KSA, wholesale medical disposables Eastern Province, Abqaiq healthcare suppliers, hospital equipment exporter Saudi Arabia, Abqaiq General Hospital supplies.";
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
                Global Manufacturer & Exporter of Surgical & Medical Supplies to Abqaiq
              </h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Delivering precision-crafted surgical instruments, certified PPE, and premium medical disposables to support the essential healthcare needs of Abqaiq’s community and workforce.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={catalogPDF} download="Alira-Pharmaceuticals-Catalog.pdf" className="px-8 py-3 rounded-md border-2 border-teal-100 text-teal-50 font-semibold hover:bg-white hover:text-teal-900 transition-colors inline-block text-center">Download Abqaiq Product Catalog</a>
              ...
              <div className="w-full lg:w-5/12 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 bg-gray-100 group">
                  <img 
                    ...
                    alt="Alira Medical Export Abqaiq" 
                    width={400}
                    height={500}
                ...
                <div className="space-y-10 text-gray-700 leading-relaxed text-justify">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">
                      Pharmaceutical Distributors for Abqaiq
                    </h3>
                    <p>
                      Alira Pharmaceuticals specializes in the strategic sourcing and distribution of generic medications and essential medical supplies tailored for the <span className="font-semibold text-teal-700">Abqaiq healthcare market</span>. We serve the region’s medical centers and industrial clinics, ensuring they receive compliant, high-efficacy products that meet international safety and SFDA standards.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">
                      Surgical Instruments Suppliers in Abqaiq
                    </h3>
                    <p>
                      We provide <span className="font-semibold text-teal-700">Abqaiq’s medical teams</span> with the precision they demand. Our Surgical Instruments are forged from medical-grade stainless steel, ensuring durability for procedures in institutions like Abqaiq General Hospital. From Retractors to specialized surgical tools, we are your trusted partner for clinical excellence.
                    </p>
                  </div>
              ...
              <div className="w-full lg:w-1/2 relative">
                ...
                <div className="relative rounded-[3rem] overflow-hidden shadow-2xl aspect-4/3 group">
                  <img 
                    ...
                    alt="Global Medical Logistics for Abqaiq" 
                    width={600}
                    height={450}
                    className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
        ...
        {/* --- WHY CHOOSE ALIRA ABQAIQ --- */}
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">
                Why Choose Alira for Abqaiq Exports?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                <div className="w-16 h-16 bg-teal-50 rounded-2xl flex items-center justify-center text-teal-600 mb-8 group-hover:bg-teal-600 group-hover:text-white transition-colors duration-500">
                  <Factory className="w-8 h-8" strokeWidth={1.5} title="Industrial Sector Support" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Industrial Sector Support</h3>
                <p className="text-gray-600 leading-relaxed">
                  We specialize in high-volume wholesale orders designed to meet the rigorous safety standards of Abqaiq’s unique industrial and community healthcare landscape.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">
                  20+ years of experience in international shipping with optimized routes to the Eastern Province, ensuring efficient delivery to Abqaiq.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
                  Leading Medical Supply Manufacturers for Abqaiq
                </h3>
              </div>
              <div className="w-full md:w-7/12">
                <p className="text-gray-600 text-lg leading-relaxed text-justify">
                  Alira Pharmaceuticals offers a unique variety of surgical instruments, PPE, and medical disposables tailored for the <span className="font-semibold text-teal-700">Abqaiq market</span>. We are a prominent manufacturer and supplier in the healthcare industry, with 20+ years of experience navigating international shipping and Saudi customs requirements. Following the latest regulatory standards, our supplies add reliability and operational efficiency to your medical facility in Abqaiq.
                </p>
              </div>
            </div>
