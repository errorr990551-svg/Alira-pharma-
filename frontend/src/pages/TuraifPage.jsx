...
const faqData = [
  {
    question: "Do you export surgical instruments directly to Turaif?",
    answer: "Yes, Alira Pharmaceutical has a dedicated export wing that handles direct shipments to public and private hospitals, distributors, and clinics throughout the Turaif region."
  },
  {
  ...
  {
    question: "What is the typical lead time for an export order to Turaif?",
    answer: "Lead times vary based on volume, but our logistics network is optimized for fast transit to the Northern Borders Province and subsequent delivery to Turaif."
  },
  {
    question: "Can I request a bulk quote for medical disposables in Turaif?",
  ...
  {
    question: "Do you provide samples to Turaif hospitals?",
    answer: "Yes, we understand the need for quality assurance. We can arrange for product samples to be sent to your facility in Turaif for evaluation by your clinical or procurement team."
  }
];
...
const TuraifPage = () => {
    ...
    useEffect(() => {
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Turaif";
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of high-quality surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for hospitals and clinics in Turaif and the Northern Borders Province.";
        ...
        const keywordsContent = "Surgical instruments Turaif, medical supplies Turaif KSA, wholesale medical disposables Northern Borders Province, Turaif healthcare suppliers, hospital equipment exporter Saudi Arabia, Turaif General Hospital supplies.";
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
        <div className="relative bg-teal-900 pt-32 pb-48 lg:pt-40 lg:pb-64 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')` }}>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">Global Manufacturer & Exporter of Surgical & Medical Supplies to Turaif</h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">Supporting the healthcare needs of Turaif with precision-crafted surgical instruments, certified PPE, and premium medical disposables tailored for the Northern Borders Province’s medical sector.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={catalogPDF} download="Alira-Pharmaceuticals-Catalog.pdf" className="px-8 py-3 rounded-md border-2 border-teal-100 text-teal-50 font-semibold hover:bg-white hover:text-teal-900 transition-colors inline-block text-center">Download Turaif Product Catalog</a>
            ...
            <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
              <div className="w-full lg:w-5/12 relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 bg-gray-100 group">
                  <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=800" alt="Alira-Medical-Export-Turaif" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
        ...
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20"><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">Why Choose Alira for Turaif Exports?</h2><div className="h-1.5 w-24 bg-teal-500 mx-auto rounded-full"></div></div>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <p className="text-gray-600 leading-relaxed">20+ years of experience in international shipping with optimized routes to the Northern Borders Province, ensuring efficient delivery to Turaif and its surrounding areas.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12"><h2 className="text-xl md:text-2xl font-bold text-teal-600 uppercase tracking-widest mb-2">MEDICAL SUPPLIES EXPORT</h2><h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">Leading Medical Supply Manufacturers for Turaif</h3></div>
              <div className="w-full md:w-7/12"><p className="text-gray-600 text-lg leading-relaxed text-justify">Alira Pharmaceutical offers a unique variety of surgical instruments, PPE, and medical disposables tailored for the <span className="font-semibold text-teal-700">Turaif market</span>. We are a prominent manufacturer and supplier in the healthcare industry, leveraging major shipping routes to the <span className="font-semibold text-teal-700">Northern Borders Province</span> for faster delivery. Following the latest regulatory standards, our supplies add reliability and operational efficiency to your medical facility in Turaif.</p></div>
            </div>
