...
const faqData = [
  ...
  {
    question: "What is the typical lead time for an export order to Medina?",
    answer: "Lead times vary based on order volume, but our strategic logistics network is optimized for fast transit to the Saudi market. Contact our Export Team for a specific timeline based on your requirements in Madinah."
  },
  {
    question: "Can I request a bulk quote for medical disposables in Medina?",
    answer: "Absolutely. We specialize in wholesale supply. You can Request a Quote via our website, and our team will provide competitive pricing tailored for the Medina market."
  },
  {
    question: "Do you provide samples before a bulk purchase in Medina?",
    answer: "We understand the need for quality assurance. We can arrange for product samples to be sent to your facility in Medina for evaluation by your clinical or procurement team."
  }
];
...
const MedinaPage = () => {
    ...
    useEffect(() => {
        // SEO Configuration
        document.title = "Top Surgical Instruments & Medical Supplies Exporter to Medina (Madinah)";

        // Update Meta Description
        let metaDescription = document.querySelector('meta[name="description"]');
        const descriptionContent = "Leading manufacturer of high-quality surgical instruments, PPE, and medical disposables. Reliable export and supply chain solutions for hospitals and clinics in Medina, Saudi Arabia.";
        ...
        const keywordsContent = "Surgical instruments Medina, medical supplies Madinah, wholesale medical disposables Medina, pharmaceutical distributors Madinah, medical equipment exporter Saudi Arabia, hospital supplies Al-Madinah.";
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
        ...
        >
          ...
          <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Global manufacturer exporting surgical and medical supplies to healthcare institutions in Madinah." className="sr-only" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
                Global Manufacturer & Exporter of Surgical & Medical Supplies to Medina
              </h1>
              <p className="text-lg md:text-xl text-teal-50 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Delivering precision-crafted surgical instruments, certified PPE, and premium medical disposables to support the expanding healthcare infrastructure of the Holy City of Madinah.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={catalogPDF} download="Alira-Pharmaceuticals-Catalog.pdf" className="px-8 py-3 rounded-md border-2 border-teal-100 text-teal-50 font-semibold hover:bg-white hover:text-teal-900 transition-colors inline-block text-center">Download Madinah Product Catalog</a>
        ...
        {/* --- WHY CHOOSE ALIRA MEDINA --- */}
        <div className="bg-teal-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">
                Why Choose Alira for Medina Exports?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Regional Logistics Expertise</h3>
                <p className="text-gray-600 leading-relaxed">
                   20+ years of experience in international shipping with a streamlined logistics network serving the Al-Madinah Province.
                </p>
              </div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group border border-teal-100/50">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Bulk Supply Chains</h3>
                <p className="text-gray-600 leading-relaxed">
                   We specialize in high-volume wholesale orders for large hospital networks and private healthcare groups in Medina.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
              <div className="w-full md:w-5/12">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
                   Leading Medical Supply Manufacturers for Medina
                </h3>
              </div>
