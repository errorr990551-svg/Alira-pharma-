  ...
  return (
    <div className="bg-gray-50 min-h-screen pt-20">
      ...
      <div className="bg-teal-900 py-16 lg:py-24 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center mix-blend-overlay"></div>
          ...
          >
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="flex flex-wrap gap-4 mt-6">
                <Link
                  to={`/products/bone-neuro/${createSlug(item.name)}/`}
