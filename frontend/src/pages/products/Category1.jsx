          ...
          >
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative group rounded-2xl overflow-hidden shadow-xl border-4 border-white bg-white">
                ...
                {/* Changed aspect class for valid Tailwind and Replaced img with ZoomableImage component */}
                <div className="aspect-4/3 overflow-hidden relative">
                   <ZoomableImage src={item.image} alt={item.name} />
                </div>

                {/* Decorative Accent (added pointer-events-none so it doesn't block the hover) */}
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="flex flex-wrap gap-4 mt-6">
                <Link
                  to={`/products/surgical-instruments/${createSlug(item.name)}/`}
